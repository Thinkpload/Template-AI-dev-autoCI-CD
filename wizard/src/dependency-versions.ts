...
export const ESLINT_VERSION = '10.1.0';

/** typescript-eslint — TypeScript-aware ESLint rules */
export const TYPESCRIPT_ESLINT_VERSION = '8.57.2';

// ─── Testing ────────────────────────────────────────────────────────────────

/** vitest — unit/integration test runner v4 */
export const VITEST_VERSION = '4.1.2';

/** @vitest/coverage-v8 — V8-based coverage for vitest */
export const VITEST_COVERAGE_V8_VERSION = '4.1.2';
